...
=== Azure and .NET Core
include::{includedir}/products_conventions/azure-dotnet.adoc[]

=== Red Hat AMQ
include::{includedir}/products_conventions/amq7.adoc[]

=== Red Hat Ceph Storage
include::{includedir}/products_conventions/ceph.adoc[]

=== Red Hat CloudForms
include::{includedir}/products_conventions/red-hat-cloudforms.adoc[]

=== Red Hat JBoss BRMS and Red Hat JBoss BPM Suite
include::{includedir}/products_conventions/bxms.adoc[]

=== Red Hat JBoss Enterprise Application Platform
include::{includedir}/products_conventions/jboss-eap.adoc[]

=== Red Hat JBoss Fuse
include::{includedir}/products_conventions/fuse.adoc[]

=== Red Hat OpenShift
include::{includedir}/products_conventions/openshift.adoc[]

=== Red Hat OpenStack Platform
include::{includedir}/products_conventions/red-hat-openstack-platform.adoc[]

=== Red Hat Satellite 6
include::{includedir}/products_conventions/red-hat-satellite6.adoc[]
